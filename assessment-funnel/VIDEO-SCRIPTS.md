...
1. **Call out the avatar (0:00-0:08).** "If you run a company and you're
   over 40, and you know something's off even though your doctor says you're
   fine, this is for you."
2. **The mechanism (0:08-0:20).** "Your doctor grades you against 'normal.'
   Normal is the average of sick people. Half of heart attack patients had
   normal cholesterol on their last labs. That's why you feel it and your
   labs don't show it."
...
4. **What happens here (0:28-0:48).** "Below this video is the same intake
   every client of ours starts with. 13 questions, 3 minutes: your
...
2. **The homework promise (0:08-0:22).** "Before we get on, we go through
   ...
   what your answers point to and what I'd want to test first. You won't
   repeat yourself, and we won't waste your 15 minutes on questions you
   already answered."
3. **What they walk away with (0:22-0:40).** "On the call you get 3 things.
   Our read on what's likely driving what you're feeling. The specific tests
   that would confirm it or clear it, whether you run them with us or with
   your own doctor. And a straight answer on whether we're the right team
   for you."
4. **De-risk (0:40-0:52).** "There's no pitch at the end. If we're the wrong
   fit, I'll tell you, and I'll tell you who to go see instead. We take on a
   limited number of clients, so we're as selective as you are."
5. **Close (0:52-0:60).** "Pick a time that's actually calm on your calendar.
   Come as you are. We'll bring the homework."

**Delivery:** slower than video 1, minute-2-of-a-consult energy. The
homework promise and the no-pitch promise carry the show rate; say both
plainly and mean them.
...
- "We do the homework before the call" is the strongest booking motivator
  for this avatar: they've been burned by rushed doctors who never read the
  chart. It's the exact opposite of the villain in the market research.
- The "no pitch, and I'll tell you who to see instead" line protects show
  rates and mirrors the skepticism theme in the messaging file.
- Neither video mentions price. Pricing stays on the call.
